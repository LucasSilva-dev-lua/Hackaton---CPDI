...
function scene:create( event )
    ...
    local esg= display.newImageRect (grupoMain, "imagens/ambiente2.png", 130, 157)
	esg.x = 250
	esg.y = 60
...
--Definindo navegação por imagens
	...
	next.x = 280
	next.y = 525
	next:addEventListener ("tap", gotoTema2)
	...
	-- voltar:addEventListener ("tap", gotoTema)
	...
	-- proximo:addEventListener ("tap", gotoTema2)

	-- Definindo o texto grande
	local textoGrande = "Ambiental (Environmental): Refere-se ao impacto ambiental das operações da empresa, incluindo questões como mudança climática, emissão de gases de efeito estufa, uso de recursos naturais, gestão de resíduos, conservação da biodiversidade e práticas de sustentabilidade ambiental."
